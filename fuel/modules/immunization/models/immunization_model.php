...
class immunization_model extends Base_module_model {
...
//	protected $key_field = 'dReceivedDate';
	...
	function savegeneralinfo($post){
	    ...
	    $this->db->insert('ocop_immunization', $data);  
	...
	function checkrecord($_REQUEST) {
		...
		$checkdata = "select * from ocop_immunization where household_voters_id = '".$household_id."' and summary_id = '".$child_name."' LIMIT 0,1";
...
class immunizationmodel extends Base_module_record {
