...
class Users_model extends Base_module_model {
	...
	$sql = "SELECT count( household_entry_id ) as household_entry, sum( entry_tot_no_childrns ) as tot_no_childrns FROM household_entry LEFT JOIN ocop_general_info ON ocop_general_info.ocop_general_info_id = household_entry.household_entry_id";
