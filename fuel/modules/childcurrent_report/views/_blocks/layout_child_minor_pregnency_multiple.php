...
<div id="contentsholder" class="flexcroll" style="width:99.5%; height:750px; overflow-x:hidden !important; overflow-y:scroll;">
	<div id="chart">
	&nbsp;
		<p>Note:These values present in the Bar Chart are taken from household entry</p>
&nbsp;
  <svg></svg>
</div>
<table cellpadding="0" cellspacing="0" border="0">
	<tr>
<td><p>Note:These values present in the graph are not live data</p></td>
<td><svg id="test1"></svg></td>
</tr>
<tr><td><p style="color:red">School Type : Government , Private, NGO,  Other</p></td></tr></table>
	</div>-->
</div>
</div>
...
$("#txtclickpdf1").click(function() {
	...
	$.ajax({  
		...
		success: function(msg){  
			...
			var url = "<?php echo fuel_url('childcurrent_report/childchildminor_pdf');?>/?"+dataStringone;
		    window.open(url);
		}  
	}); 
	}
...
$("#txtclickpdf").click(function() {
	...
	$.ajax({  
		...
		success: function(msg){  
			var dataStringone =  'txtpanchayat='+txtpanchayat+'&txtyear='+txtyear+'&txtreportlevel='+txtreportlevel+'&txttaluk='+txttaluk+'&txtdistrict='+txtdistrict+'&txtdivision='+txtdivision+'&txtstate='+txtstate;
			var url = "<?php echo fuel_url('childcurrent_report/childchild_minor_pdf');?>/?"+dataStringone;
		    window.open(url);
		}  
	}); 
	}
