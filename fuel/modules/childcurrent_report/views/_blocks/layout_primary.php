...
$("#txtclickpdf").click(function() {
	...
	$.ajax({  
		...
		success: function(msg){  
			...
			var url = "<?php echo fuel_url('childcurrent_report/childprimary_pdf');?>/?"+dataStringone;
		    window.open(url);
		}  
	}); 
	}
...
for(j=0;j<name.length;j++) { 
   ...
   dataArrayFinal[j] = temp;     
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'Primary - Childrens Population (General Age Break up)'
        },
        tooltip: {
...
//alert(retData);
 ...
 $('#container1').highcharts({
            ...
            xAxis: {
                categories: [
                    'Primary Childrens Population (General Age Break up)'
                ]
            },
            yAxis: {
                min: 0,
