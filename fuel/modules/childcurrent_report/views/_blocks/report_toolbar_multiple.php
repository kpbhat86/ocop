...
<tr>		
		<td>
			...
			<td style="width:40% !important;">
					...
					<select id="ddlpanchayat"  name="ddlpanchayat" multiple="multiple" style="min-width:200px;" >
					<option value="">-- Select --</option>
				</select>
			</td>
			</tr>
...
<div id="action">
	<div id="actions" class="reportbuttonbar">
		...
		<input id="txtpanchayat" name="txtpanchayat" type="hidden"   />
			<li class="spacer end">
					<label><strong>Gramapanchayat:</strong></label></br>
					<select id="ddlpanchayat"  name="ddlpanchayat" style="min-width:200px;" multiple="multiple">
			...
			<li class="spacer end">
				<label><strong>Report Level:</strong></label></br>
