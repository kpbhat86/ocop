...
<p class="instructions">H1. Household Survey</p>
<div id="householdsurveyfrm" class="pad-10">
<form id="savehouseholdsurvey" name="savehouseholdsurvey" method="post" action="<?php echo fuel_url('household_survey/savehouseholdsurvey');?>" onSubmit="return chksavehouseholdsurvey();">
<div class="pad-5">
...
<fieldset>
	...
	<tr>
		...
		<td class="value">
			...
			<input type="hidden" id="txttotnum" name="txttotnum" />
		</td>
	</tr>
	<tr>
		<td class="label">
...
<div class="pad-10">
	<input id="Save" class="submit" type="submit" value="Save" name="Save" />
